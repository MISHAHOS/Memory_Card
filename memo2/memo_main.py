...
def testlist():
    frm = Question('Майнкрафт', 'Minecraft', 'minekraft', 'minekaft', 'mine')
    questions_listmodel.form_list.append(frm)
    frm = Question('Террария', 'Terraria', 'teraria', 'trearia', 'terraia')
    questions_listmodel.form_list.append(frm)
    frm = Question('Дум', 'doom', 'doon', 'dom', 'domm')
    questions_listmodel.form_list.append(frm)
    frm = Question('Гта', 'Gta', 'GTT', 'goa', 'ggg')
    questions_listmodel.form_list.append(frm)
